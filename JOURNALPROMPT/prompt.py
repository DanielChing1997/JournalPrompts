...
'React to the following quote from Anaïs Nin: We dont see things as they are, we see them as we are.',
...
'When was the last time you had to hold your tongue? What would you have said if you didnt have to?',
...
print(random.choice(journalPrompts))